# Accurate Logistics Integration for Odoo 19

End-to-end integration between **Odoo 19 Community** and the
...
- Odoo **19.0** Community (primary target)
- Odoo **18.0** Community (compatible — payment register flow uses the same wizard)
